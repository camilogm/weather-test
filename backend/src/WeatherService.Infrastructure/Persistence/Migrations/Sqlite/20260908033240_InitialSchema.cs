        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    location_key = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
                    location_name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    latitude = table.Column<double>(type: "REAL", nullable: false),
                    longitude = table.Column<double>(type: "REAL", nullable: false),
                    retrieved_at_utc = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    forecast_snapshot_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    date = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    min_temperature_c = table.Column<double>(type: "REAL", nullable: false),
                    max_temperature_c = table.Column<double>(type: "REAL", nullable: false),
